...
import { StyleSheet, Image, Text, View, Picker,StatusBar, ImageBackground } from "react-native"
...
const NewHome = ({navigation}) => {
  ...
  const startOfYear = (curdate) => {
    ...
    const getDateData = async (newdate, ntype) => {
      console.log('newdate = ',newdate)
      setConfirmdate(newdate)
      const conf = await config();
      const url = conf.apiUrl +'/reports/statistics'; //"http://localhost:3001/v1/api/users/login"//"http://bkadmin.in/indoapp/user/userLogin"
      let newtype=ntype
      if(ntype == 'quarterly'){
        newtype = 'quarter'
      }
      console.log('ntype = ',ntype)
      const data = {filter: newtype, date: newdate, business_code: businesstype.code };
    ...
    const changetype = (ntype) => {
      ...
      getDateData(confirmdate, ntype.toLowerCase());
    }

    const setbusinesstype = async () => {
    ...
    return (
      ...
      />
        ...
        <Text>Could not connect to internet</Text>
          ...
          <Text style={styles.Txt142}>{displaydt}</Text>
          ...
          <TouchableOpacity style={styles.IconlyBoldCalendar} onPress={() => setOpencalendar(true)}>
          <Image
          ...
          <>
            ...
            <DataTable rowHeight={30} key={index} >
              <DataTable.Header  style={styles.tableHeader}>
                <Text style={styles.Txt672}>{item.net_stale.type == 'National' ? businesstype.name :item.net_stale.type } </Text>
              {/* <TouchableOpacity style={{position: 'absolute', right: 0, top: 0}}> */}
                <IconButton
                  onPress={() => setcollapsVal(index)}
                  style={{position: 'absolute', right: 0, top: -6, zIndex:1000}}
              ...
              <View style={styles.tableRow}>
                ...
                {Math.sign(item.net_stale.val).toString() === 'NaN'  || Math.sign(item.net_stale.val) >0?
                (<IconButton
                  // onPress={() => setcollapsVal(index)}
                  style={styles.iconposbtn}
              ...
              <View style={styles.tableRow}>
                ...
                {Math.sign(item.ADS.val).toString() === 'NaN' || Math.sign(item.ADS.val) >0 ?
                (<IconButton
                  disableFocusRipple={true}
                  style={styles.iconposbtn}
                  // iconContainerStyle={{position: 'absolute', top:0,right:0}}
              ...
              <View style={styles.tableRow}>
                ...
                {Math.sign(item.SSSG.val).toString() === 'NaN' || Math.sign(item.SSSG.val) >0?
                (<IconButton
                  disableFocusRipple={true}
                  style={styles.iconposbtn}
                  // iconContainerStyle={{position: 'absolute', top:0,right:0}}
              ...
              >
                ...
                <View style={styles.tableRow}>
                  ...
                  {Math.sign(item.SSTG.val).toString() === 'NaN' || Math.sign(item.SSTG.val) >0?
                  (<IconButton
                    disableFocusRipple={true}
                    style={styles.iconposbtn}
                    // iconContainerStyle={{position: 'absolute', top:0,right:0}}
                ...
                <View style={styles.tableRow}>
                  ...
                  {Math.sign(item.ADT.val).toString() === 'NaN'  || Math.sign(item.ADT.val) >0?
                  (<IconButton
                    disableFocusRipple={true}
                    style={styles.iconposbtn}
                    // iconContainerStyle={{position: 'absolute', top:0,right:0}}
                ...
                <View style={styles.tableRow}>
                  ...
                  {Math.sign(item.APC.val).toString() === 'NaN'  || Math.sign(item.APC.val) >0  ?
                  (<IconButton
                    disableFocusRipple={true}
                    style={styles.iconposbtn}
                    // iconContainerStyle={{position: 'absolute', top:0,right:0}}
                ...
                <View style={styles.tableRow}>
                  ...
                  {Math.sign(item.WOWSSSG.val).toString() === 'NaN'  || Math.sign(item.WOWSSSG.val) >0 ?
                  (<IconButton
                    disableFocusRipple={true}
                    style={styles.iconposbtn}
                    // iconContainerStyle={{position: 'absolute', top:0,right:0}}
                ...
                <View style={styles.tableRow}>
                  ...
                  {Math.sign(item.MOMSSSG.val).toString() === 'NaN'  || Math.sign(item.MOMSSSG.val) >0 ?
                  (<IconButton
                    disableFocusRipple={true}
                    style={styles.iconposbtn}
                    // iconContainerStyle={{position: 'absolute', top:0,right:0}}
                ...
                <View style={styles.tableRow}>
                  ...
                  {Math.sign(item.DINEINNETSALES.val).toString() === 'NaN' || Math.sign(item.DINEINNETSALES.val) >0 ?
                  (<IconButton
                    disableFocusRipple={true}
                    style={styles.iconposbtn}
                    // iconContainerStyle={{position: 'absolute', top:0,right:0}}
                ...
                <View style={styles.tableRow}>
                  ...
                  {Math.sign(item.DINEINADS.val).toString() === 'NaN' || Math.sign(item.DINEINADS.val) >0 ?
                  (<IconButton
                    disableFocusRipple={true}
                    style={styles.iconposbtn}
                    // iconContainerStyle={{position: 'absolute', top:0,right:0}}
                ...
                <View style={styles.tableRow}>
                  ...
                  {Math.sign(item.DELIVERYPERCENT.val).toString() === 'NaN' || Math.sign(item.DELIVERYPERCENT.val) >0 ?
                  (<IconButton
                    disableFocusRipple={true}
                    style={styles.iconposbtn}
                    // iconContainerStyle={{position: 'absolute', top:0,right:0}}
...
const styles = StyleSheet.create({
  ...
  iconposbtn:{
    position: 'absolute', flex:1, height:7, marginTop:0, paddingTop:0, width:20, right: 0, bottom: 30, zIndex:1000
  },
    header:{
        // display: "flex",
        // boxSizing: 'border',
